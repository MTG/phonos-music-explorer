...
def update_sliders():
    play.update_sliders(request.form['slider1'], request.form['slider2'], request.form['slider3'],
                        request.form['slider4'], request.form['slider5'], request.form['slider6'],
                        request.form['slider7'], request.form['slider8'], request.form['slider9'],
                        request.form['slider10'])
    return request.form['slider1']


@app.route('/back', methods=['POST'])
def on_exit():
    print "Received the request to shut down the server"
...
def activate_sliders():
    play.activate_sliders(request.form['loudness'], request.form['noisiness'], request.form['sparseness'],
                          request.form['bass'], request.form['high'])
    return request.form['loudness']


@app.route('/segmentlength', methods=['POST'])
def changelength():
    play.change_segment_length(request.form['length'])
